 ...
 * TblPedido
 *
 * @ORM\Table(name="tbl_pedido", indexes={@ORM\Index(name="ID_ENCARGADO", columns={"ID_ENCARGADO"}), @ORM\Index(name="ID_USUARIO_ASIGNADO", columns={"ID_USUARIO_ASIGNADO"}), @ORM\Index(name="ID_CLIENTE", columns={"ID_CLIENTE"})})
 * @ORM\Entity
 */
class TblPedido
{
