 ...
 * TblDetallePedido
 *
 * @ORM\Table(name="tbl_detalle_pedido", indexes={@ORM\Index(name="ID_LOTE", columns={"ID_LOTE"}), @ORM\Index(name="ID_PEDIDO", columns={"ID_PEDIDO"}), @ORM\Index(name="ID_PRODUCTO_DETALLE", columns={"ID_PRODUCTO_DETALLE"})})
 * @ORM\Entity
 */
