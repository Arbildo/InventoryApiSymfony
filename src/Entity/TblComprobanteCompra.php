 ...
 *
 * @ORM\Table(name="tbl_comprobante_compra", indexes={@ORM\Index(name="ID_PROVEEDOR", columns={"ID_PROVEEDOR"}), @ORM\Index(name="ID_TIPO_COMPROBANTE", columns={"ID_TIPO_COMPROBANTE"})})
 * @ORM\Entity
 */
